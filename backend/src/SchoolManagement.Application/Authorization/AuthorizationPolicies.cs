...
public static class AuthorizationPolicies
{
    ...
    public static class RoleSets
    {
        ...
        public static readonly string[] FinanceRead = [InstitutionalRoles.SystemAdministrator, InstitutionalRoles.FinanceOfficer, InstitutionalRoles.Principal, InstitutionalRoles.HeadOfDepartment, InstitutionalRoles.ResidentDirector, InstitutionalRoles.Secretary];
