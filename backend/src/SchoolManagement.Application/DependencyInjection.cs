...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<FinanceService>(); services.AddScoped<FinanceWorkflowService>(); services.AddScoped<InvoiceDiscountService>(); services.AddScoped<InvoiceInstallmentService>(); services.AddScoped<StudentChargeService>(); services.AddScoped<CreditNoteRefundService>(); services.AddScoped<FinanceReportService>(); services.AddScoped<CashBankPositionReportService>(); services.AddScoped<ReceivablesReportService>(); services.AddScoped<JournalReversalService>(); services.AddScoped<FinanceAdministrationService>(); services.AddScoped<FiscalPeriodService>(); services.AddScoped<OpeningBalanceService>(); services.AddScoped<BudgetService>(); services.AddScoped<FiscalPeriodClosingService>(); services.AddScoped<BankReconciliationService>(); services.AddScoped<BankReconciliationImportService>();
