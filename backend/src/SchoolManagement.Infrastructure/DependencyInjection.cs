...
public static class DependencyInjection
{
 public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
 {
  ...
  services.AddScoped<SchoolManagement.Infrastructure.Persistence.FinanceRepository>();
  services.AddScoped<SchoolManagement.Application.Abstractions.IFinanceRepository>(sp => sp.GetRequiredService<SchoolManagement.Infrastructure.Persistence.FinanceRepository>());
  services.AddScoped<SchoolManagement.Application.Finance.IFinanceRepository>(sp => sp.GetRequiredService<SchoolManagement.Infrastructure.Persistence.FinanceRepository>());
  services.AddScoped<IFinanceAdjustmentsRepository>(sp => sp.GetRequiredService<SchoolManagement.Infrastructure.Persistence.FinanceRepository>());
  services.AddScoped<IFiscalPeriodRepository, FiscalPeriodRepository>(); services.AddScoped<IBudgetRepository, BudgetRepository>(); services.AddScoped<IBankReconciliationRepository, BankReconciliationRepository>(); services.AddScoped<IFeeRepository, FeeRepository>();
  services.AddScoped<SchoolManagement.Application.Finance.BudgetService>(); services.AddScoped<SchoolManagement.Application.Finance.BankReconciliationService>(); services.AddScoped<SchoolManagement.Application.Finance.OpeningBalanceService>(); services.AddScoped<SchoolManagement.Application.Finance.FiscalYearCarryForwardService>(); services.AddScoped<SchoolManagement.Application.Finance.FiscalPeriodService>(); services.AddScoped<SchoolManagement.Application.Finance.FiscalPeriodClosingService>(); services.AddScoped<SchoolManagement.Application.Finance.JournalReversalService>(); services.AddScoped<SchoolManagement.Application.Finance.CreditNoteRefundService>(); services.AddScoped<SchoolManagement.Application.Finance.StudentChargeService>(); services.AddScoped<SchoolManagement.Application.Finance.FinancialStatementsService>(); services.AddScoped<SchoolManagement.Application.Finance.AdjustmentCancellationService>();
  services.AddScoped<WelfareInventoryService>(); services.AddScoped<IHostelRepository, HostelRepository>(); services.AddScoped<SchoolManagement.Application.Hostel.HostelService>(); services.AddScoped<ITransportRepository, TransportRepository>(); services.AddScoped<SchoolManagement.Application.Transport.TransportService>();
