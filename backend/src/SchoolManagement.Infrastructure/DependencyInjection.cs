...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<SchoolManagement.Application.Students.IStudentPromotionRepository, StudentPromotionRepository>();
        services.AddScoped<SchoolManagement.Application.Progression.ISemesterProgressionRepository, SemesterProgressionRepository>();
        ...
        services.AddScoped<SchoolManagement.Application.Students.IStudentRecordsRepository, StudentRecordsRepository>();
