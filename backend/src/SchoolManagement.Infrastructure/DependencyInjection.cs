...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<SchoolManagement.Application.Finance.BudgetService>(); services.AddScoped<SchoolManagement.Application.Finance.BankReconciliationService>();
        services.AddScoped<SchoolManagement.Application.Finance.OpeningBalanceService>(); services.AddScoped<SchoolManagement.Application.Finance.FiscalYearCarryForwardService>();
