...
public static class DependencyInjection
{
 public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
 {
  ...
  services.AddScoped<IHostelRepository, HostelRepository>(); services.AddScoped<SchoolManagement.Application.Hostel.HostelService>(); services.AddScoped<ITransportRepository, TransportRepository>(); services.AddScoped<SchoolManagement.Application.Transport.TransportService>();
