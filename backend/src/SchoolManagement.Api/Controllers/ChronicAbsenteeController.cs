...
{
    [HttpGet("report")]
    public async Task<IActionResult> GetChronicAbsenteeReport([FromQuery] int thresholdDays = 10, [FromQuery] int periodDays = 30, CancellationToken cancellationToken)
    {
        ...
        var students = await db.Students.AsNoTracking()
            ...
            .Select(s => new { s.Id, s.StudentNumber, s.FirstName, s.LastName, s.OtherNames, s.PhoneNumber })
            .ToListAsync(cancellationToken);
        ...
        var result = absences.Select(a =>
        {
            ...
            return new
            {
                ...
                a.AbsenceCount,
                a.TotalSessions,
                absenceRate = Math.Round(a.AbsenceRate * 100, 1),
                isChronic = a.AbsenceRate > 0.3
            };
        }).ToList();
    ...
    [HttpGet("alerts")]
    public async Task<IActionResult> GetAbsenteeAlerts([FromQuery] int periodDays = 30, CancellationToken cancellationToken)
    {
        var fromDate = DateOnly.FromDateTime(DateTime.UtcNow.AddDays(-periodDays));
        ...
        var alerts = absences.Select(a =>
        {
            ...
            return new
            {
                ...
                phoneNumber = student?.PhoneNumber,
                a.AbsenceCount,
                absenceRate = Math.Round(rate * 100, 1),
