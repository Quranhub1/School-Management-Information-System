...
public sealed record CreateStaffRequest(string StaffNumber, string FirstName, string LastName, string? NationalId, string? PhoneNumber, string? Email, string EmploymentType, SchoolManagement.Domain.Staff.StaffType StaffType);
