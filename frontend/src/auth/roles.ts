export const ROLES = { systemAdministrator: 'SystemAdministrator', registrar: 'Registrar', academicRegistrar: 'AcademicRegistrar', financeOfficer: 'FinanceOfficer', lecturer: 'Lecturer', examinationsOfficer: 'ExaminationsOfficer', student: 'Student' } as const
...
export const ADMINISTRATION_ROLES = [ROLES.systemAdministrator] as const
